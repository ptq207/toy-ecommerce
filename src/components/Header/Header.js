...
const Header = ({
  ...
  if (!pathname.includes('/sellercenter/') && !pathname.includes('/drive/')) {
    return (
      <Navbar
        collapseOnSelect
        expand="lg"
      ...
      >
        <Container>
          <Navbar.Brand href="/home">Bisubeo's corner</Navbar.Brand>
