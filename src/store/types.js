...
export const LOAD_SELLER_ORDER_INIT = 'LOAD_SELLER_ORDER_INIT';
export const LOAD_SELLER_ORDER_SUCCESS = 'LOAD_SELLER_ORDER_SUCCESS';
export const LOAD_SELLER_ORDER_ERROR = 'LOAD_SELLER_ORDER_ERROR';

export const LOAD_SELLER_PRODUCT_INIT = 'LOAD_SELLER_PRODUCT_INIT';
export const LOAD_SELLER_PRODUCT_SUCCESS = 'LOAD_SELLER_PRODUCT_SUCCESS';
export const LOAD_SELLER_PRODUCT_ERROR = 'LOAD_SELLER_PRODUCT_ERROR';
